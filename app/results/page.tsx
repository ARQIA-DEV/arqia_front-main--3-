...
type SortKey = 'data_desc' | 'data_asc' | 'valor_desc' | 'valor_asc' | 'fornecedor_asc' | 'fornecedor_desc'
  cnpj?: string
  fornecedor?: string
  valor?: number
  numero_nota?: string
...
export default function ResultsPage() {
  ...
  }, [session, status, router, debouncedFilters])
      ...
      {!loading && filteredDocs.length > 0 && (
        <div className="mt-6 flex items-center justify-between">
          ...
          <button
            ...
            className={`px-3 py-2 rounded text-white transition ${
              currentPage === totalPages ? 'bg-gray-400 cursor-not-allowed' : 'bg-[#015958] hover:bg-[#008F8C]'
            }`}
          >
            Próxima página
          </button>
